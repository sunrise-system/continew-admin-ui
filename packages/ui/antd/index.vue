...
const nadaDarkMode = useStorage<boolean>('nada-dark-mode', false);
isDark.value = nadaDarkMode.value;
watch(
  () => isDark.value,
  () => {
    nadaDarkMode.value = isDark.value;
  },
);
...
const links = [
  ...
  {
    title: '更新日志',
    url: 'https://github.com/Kchengz/nada-designer/blob/develop/docs/updateLog.md',
  },
];
...
const selectOptions = [
  ...
  {
    label: 'arcoDesigneVue',
    value: 'arco-designe-vue',
  },
  {
    label: 'elementPlus',
    value: 'element-plus',
...
<template>
  <div class="nada-demo-header h-64px flex items-center justify-between px-6">
    <a
    ...
    <div class="nada-demo-header-right flex items-center">
      <a
