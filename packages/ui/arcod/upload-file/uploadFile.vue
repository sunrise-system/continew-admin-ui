...
import { Button, Notification, Upload } from '@arco-design/web-vue';
...
const beforeUpload = (): void => {
  ...
  // if (!isJpgOrPng) {
  //   Notification.error('您只能上传JPG/PNG文件!');
  // }
  // const isLt2M = file.size / 1024 / 1024 < 2;
  // if (!isLt2M) {
  //   Notification.error('图片大小超过 2MB!');
  // }
...
<template>
  <div class="nada-upload-file">
    <Upload v-bind="getUploadProps">
      ...
      >
        <span
          class="icon--nada icon--nada--cloud-upload-outlined text-lg"
        ></span>
