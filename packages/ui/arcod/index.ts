...
// 注册@arco-design/web-vue ui
import { pluginManager as pManager } from '@nada-designer/utils';
// import { version } from '@arco-design/web-vue';
...
export function setupArcod(pluginManager: PluginManager = pManager): void {
  // 版本兼容处理 start
...
*/
  ...
  pluginManager.component(
    'Collapse',
    async () => (await import('@arco-design/web-vue')).Collapse,
  );
  pluginManager.component(
    'CollapseItem',
    async () => (await import('@arco-design/web-vue')).CollapsePanel,
  );
  pluginManager.component(
    'Tabs',
    async () => (await import('@arco-design/web-vue')).Tabs,
  );
  pluginManager.component(
    'TabPane',
    async () => (await import('@arco-design/web-vue')).TabPane,
  );
